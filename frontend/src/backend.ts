...
import type { ExternalBlob as _ExternalBlob, Policy as _Policy, Time as _Time, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addCustomer(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async addPolicy(arg0: string, arg1: string, arg2: string, arg3: Principal, arg4: Time, arg5: Time, arg6: Time, arg7: Array<ExternalBlob>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addPolicy(arg0, arg1, arg2, arg3, arg4, arg5, arg6, await to_candid_vec_n8(this._uploadFile, this._downloadFile, arg7));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCustomer(arg0: Principal): Promise<Customer> {
        if (this.processError) {
            try {
    ...
    async getCustomerPolicies(arg0: Principal): Promise<Array<Policy>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCustomerPolicies(arg0);
    ...
    async getPolicy(arg0: string): Promise<Policy> {
        if (this.processError) {
            try {
                ...
                return from_candid_Policy_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getUpcomingExpirations(arg0: bigint): Promise<Array<Policy>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUpcomingExpirations(arg0);
                return from_candid_vec_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listCustomers(): Promise<Array<[Principal, Customer]>> {
        if (this.processError) {
            try {
    ...
    async listPolicies(): Promise<Array<[string, Policy]>> {
        if (this.processError) {
            try {
                const result = await this.actor.listPolicies();
...
async function from_candid_Policy_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Policy): Promise<Policy> {
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        documents: await from_candid_vec_n13(_uploadFile, _downloadFile, value.documents),
        validFrom: value.validFrom,
        insuranceCompany: value.insuranceCompany,
        policyType: value.policyType,
        validTo: value.validTo,
        customerId: value.customerId,
        roadTaxExpiry: value.roadTaxExpiry,
...
async function from_candid_tuple_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [string, _Policy]): Promise<[string, Policy]> {
    return [
        value[0],
        await from_candid_Policy_n11(_uploadFile, _downloadFile, value[1])
    ];
}
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Policy>): Promise<Array<Policy>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Policy_n11(_uploadFile, _downloadFile, x)));
}
...
async function from_candid_vec_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<[string, _Policy]>): Promise<Array<[string, Policy]>> {
